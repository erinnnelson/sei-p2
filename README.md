...
Header - Nav Bar with Links to Routed conditional viewing

Search - Search Input, Search Results

Search Input - Input that calls API

Search Results - Song Cards

Playlist Card - Song Cards

Song Card - Display info from API call, Add/Remove Button

Add/Remove Button - Either adds or removes a song to a playlist
